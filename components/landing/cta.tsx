      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="font-body text-body text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join thousands of students and professionals who have already started their journey to success with Scio Labs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="font-body text-gray-400 mt-8 text-sm">
            No commitment required • Free consultation available • Trusted by 1000+ institutions
          </p>
        </div>
      </div>
